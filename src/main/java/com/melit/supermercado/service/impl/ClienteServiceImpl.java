...
import com.melit.supermercado.service.mapper.ClienteMapper;
...
public class ClienteServiceImpl implements ClienteService {
    ...
    @Override
    public Page<ClienteDTO> clienteByDocumento(String documento, Pageable pageable) {
        log.debug("Request to get all Clientes by documento");
        return clienteRepository.clienteByDocumento(documento, pageable).map(clienteMapper::toDto);
    }
}
