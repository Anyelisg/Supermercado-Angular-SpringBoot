...
/**
 * Service Interface for managing {@link com.melit.supermercado.domain.Cliente}.
 */
public interface ClienteService {
    ...
    /**
     * Get all the clientes by document
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<ClienteDTO> clienteByDocumento(String documento, Pageable pageable);
