...
/**
 * Service Interface for managing {@link com.melit.supermercado.domain.Producto}.
 */
public interface ProductoService {
    ...
    /**
     * Get all the productos by codigo
     *
     * @param pageable the pagination information.
     * @return the list of entities.
     */
    Page<ProductoDTO> productoByCodigo(String codigo, Pageable pageable);
