...
export class ClienteService {
  ...
  queryByDocumento(documento: string, pageable?: any): Observable<EntityArrayResponseType> {
    const options = createRequestOption(pageable);
    return this.http.get<ICliente[]>(`${this.resourceUrl}/by-documento/${documento}`, { params: options, observe: 'response' });
  }
