...
import com.melit.supermercado.domain.enumeration.Cargo;
import com.melit.supermercado.repository.EmpleadoRepository;
import com.melit.supermercado.service.dto.EmpleadoDTO;
import com.melit.supermercado.service.mapper.EmpleadoMapper;
...
class EmpleadoResourceIT {
    ...
    void partialUpdateEmpleadoWithPatch() throws Exception {
        ...
        partialUpdatedEmpleado.nombre(UPDATED_NOMBRE).documento(UPDATED_DOCUMENTO).email(UPDATED_EMAIL);
