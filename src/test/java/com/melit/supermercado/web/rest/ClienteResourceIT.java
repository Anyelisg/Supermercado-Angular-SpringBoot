...
import com.melit.supermercado.domain.enumeration.TipoCliente;
...
class ClienteResourceIT {
    ...
    private static final TipoCliente DEFAULT_TIPO_CLIENTE = TipoCliente.PARTICULAR;
    private static final TipoCliente UPDATED_TIPO_CLIENTE = TipoCliente.EMPRESA;
    ...
    void partialUpdateClienteWithPatch() throws Exception {
        ...
        partialUpdatedCliente.direccion(UPDATED_DIRECCION);
